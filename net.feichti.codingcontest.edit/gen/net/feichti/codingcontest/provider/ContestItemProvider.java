...
/**
 * This is the item provider adapter for a {@link net.feichti.codingcontest.Contest} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContestItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public ContestItemProvider(AdapterFactory adapterFactory)
	{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Contest_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Contest_id_feature", "_UI_Contest_type"),
				 CodingcontestPackage.Literals.CONTEST__ID,
				 true,
				 false,
				 false,
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Contest"));
	}
	...
	{
		String label = ((Contest)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Contest_type") :
			getString("_UI_Contest_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(Contest.class))
		{
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(CodingcontestPackage.Literals.CONTEST__LOCATIONS,
				 CodingcontestFactory.eINSTANCE.createLocation()));

		newChildDescriptors.add
			(createChildParameter
				(CodingcontestPackage.Literals.CONTEST__LEVELS,
				 CodingcontestFactory.eINSTANCE.createLevel()));
