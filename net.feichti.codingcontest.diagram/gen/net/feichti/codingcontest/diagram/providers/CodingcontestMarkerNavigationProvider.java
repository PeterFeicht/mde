...
import net.feichti.codingcontest.diagram.part.CodingcontestDiagramEditorUtil;

/**
 * @generated
 */
public class CodingcontestMarkerNavigationProvider
		extends AbstractModelMarkerNavigationProvider
{
	...
	*/
	public static final String MARKER_TYPE =
			CodingcontestDiagramEditorPlugin.ID + ".diagnostic";  //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if(targetEditPart != null) {
			CodingcontestDiagramEditorUtil.selectElementsInDiagram(
