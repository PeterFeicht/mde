 ...
 * @generated
 */
public class CodingcontestValidationDecoratorProvider
		...
		implements IDecoratorProvider
{
	...
	* @generated
	*/
	private static final String MARKER_TYPE = CodingcontestDiagramEditorPlugin.ID +
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if(editPart instanceof GraphicalEditPart ||
			...
			if(((DiagramEditDomain) ed).getEditorPart() instanceof CodingcontestDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		View view = (View) decoratorTarget.getAdapter(
				View.class);
		return view != null && ContestEditPart.MODEL_ID.equals(CodingcontestVisualIDRegistry.getModelID(view));
	}
		...
		*/
		public void refresh() {
			...
			for(int i = 0; i < markers.length; i++) {
				...
				String attribute =
						marker.getAttribute(org.eclipse.gmf.runtime.common.ui.resources.IMarker.ELEMENT_ID, "");  //$NON-NLS-1$
