 ...
 * @generated
 */
public class ProblemTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
	...
	* @generated
	*/
	public ProblemTitleEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if(parser == null) {
			parser = CodingcontestParserProvider.getParser(CodingcontestElementTypes.Problem_2005, getParserElement(),
					CodingcontestVisualIDRegistry
							.getType(net.feichti.codingcontest.diagram.edit.parts.ProblemTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
