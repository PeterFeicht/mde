...
import net.feichti.codingcontest.diagram.edit.policies.CodingcontestTextSelectionEditPolicy;
 ...
 * @generated
 */
public class LanguageToProblemMapKeyEditPart extends LabelEditPart implements ITextAwareEditPart
{
	...
	*/
	static {
		registerSnapBackPosition(CodingcontestVisualIDRegistry
				.getType(net.feichti.codingcontest.diagram.edit.parts.LanguageToProblemMapKeyEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	...
	* @generated
	*/
	public LanguageToProblemMapKeyEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new CodingcontestTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return CodingcontestElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if(parser == null) {
			parser = CodingcontestParserProvider.getParser(CodingcontestElementTypes.LanguageToProblemMap_4001,
					getParserElement(), CodingcontestVisualIDRegistry.getType(
							net.feichti.codingcontest.diagram.edit.parts.LanguageToProblemMapKeyEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if(manager == null) {
			setManager(new TextDirectEditManager(this,
					null,
					CodingcontestEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
