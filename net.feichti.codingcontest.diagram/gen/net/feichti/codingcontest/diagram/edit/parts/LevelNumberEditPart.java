 ...
 * @generated
 */
public class LevelNumberEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
	...
	* @generated
	*/
	public LevelNumberEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if(parser == null) {
			parser = CodingcontestParserProvider.getParser(CodingcontestElementTypes.Level_2001, getParserElement(),
					CodingcontestVisualIDRegistry
							.getType(net.feichti.codingcontest.diagram.edit.parts.LevelNumberEditPart.VISUAL_ID));
		}
		return parser;
	}
