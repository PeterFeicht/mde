...
public class LocationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
	...
	*/
	public IParser getParser() {
		if(parser == null) {
			parser = CodingcontestParserProvider.getParser(CodingcontestElementTypes.Location_2003, getParserElement(),
					CodingcontestVisualIDRegistry
							.getType(net.feichti.codingcontest.diagram.edit.parts.LocationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
