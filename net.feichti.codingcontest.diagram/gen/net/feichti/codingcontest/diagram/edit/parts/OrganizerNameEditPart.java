 ...
 * @generated
 */
public class OrganizerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart
{
	...
	* @generated
	*/
	public OrganizerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if(parser == null) {
			parser = CodingcontestParserProvider.getParser(CodingcontestElementTypes.Organizer_2002, getParserElement(),
					CodingcontestVisualIDRegistry
							.getType(net.feichti.codingcontest.diagram.edit.parts.OrganizerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
