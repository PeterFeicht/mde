 ...
 * @generated
 */
public class CodingcontestBaseItemSemanticEditPolicy extends SemanticEditPolicy
{
	...
	* @generated
	*/
	protected CodingcontestBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if(request instanceof ReconnectRequest) {
			...
			if(view instanceof View) {
				Integer id = new Integer(CodingcontestVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = CodingcontestElementTypes.getElementType(getVisualID(request));
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = CodingcontestDiagramEditorPlugin.getInstance().getLinkConstraints();
		if(cached == null) {
			CodingcontestDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints
	{
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreateLanguageToProblemMap_4001(Level source, Problem target) {
			return canExistLanguageToProblemMap_4001(null, source, target);
		}
