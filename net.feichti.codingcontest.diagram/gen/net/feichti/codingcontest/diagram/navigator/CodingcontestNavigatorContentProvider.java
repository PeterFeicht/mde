 ...
 * @generated
 */
public class CodingcontestNavigatorContentProvider implements ICommonContentProvider
{
	...
	*/
	...
	public CodingcontestNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		if(parentElement instanceof IFile) {
			...
			ArrayList<CodingcontestNavigatorItem> result = new ArrayList<CodingcontestNavigatorItem>();
			...
			result.addAll(createNavigatorItems(selectViewsByType(topViews, ContestEditPart.MODEL_ID), file, false));
			return result.toArray();
		}
		
		if(parentElement instanceof CodingcontestNavigatorGroup) {
			CodingcontestNavigatorGroup group = (CodingcontestNavigatorGroup) parentElement;
			return group.getChildren();
		}
		
		if(parentElement instanceof CodingcontestNavigatorItem) {
			CodingcontestNavigatorItem navigatorItem = (CodingcontestNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		switch(CodingcontestVisualIDRegistry.getVisualID(view)) {
			...
			case ContestEditPart.VISUAL_ID: {
				...
				CodingcontestNavigatorGroup links = new CodingcontestNavigatorGroup(
						Messages.NavigatorGroupName_Contest_1000_links,
						"icons/linksNavigatorGroup.gif", parentElement);  //$NON-NLS-1$
				Collection<View> connectedViews;
				connectedViews = getChildrenByType(Collections.singleton(sv),
						CodingcontestVisualIDRegistry.getType(LevelEditPart.VISUAL_ID));
				result.addAll(createNavigatorItems(connectedViews, parentElement, false));
				connectedViews = getChildrenByType(Collections.singleton(sv),
						CodingcontestVisualIDRegistry.getType(OrganizerEditPart.VISUAL_ID));
				result.addAll(createNavigatorItems(connectedViews, parentElement, false));
				connectedViews = getChildrenByType(Collections.singleton(sv),
			...
			case LevelEditPart.VISUAL_ID: {
				...
				CodingcontestNavigatorGroup outgoinglinks = new CodingcontestNavigatorGroup(
						Messages.NavigatorGroupName_Level_2001_outgoinglinks,
			...
			case LocationEditPart.VISUAL_ID: {
				LinkedList<CodingcontestAbstractNavigatorItem> result =
						new LinkedList<CodingcontestAbstractNavigatorItem>();
				Node sv = (Node) view;
				CodingcontestNavigatorGroup incominglinks = new CodingcontestNavigatorGroup(
						Messages.NavigatorGroupName_Location_2003_incominglinks,
			...
			case ProblemEditPart.VISUAL_ID: {
				...
				Node sv = (Node) view;
				CodingcontestNavigatorGroup incominglinks = new CodingcontestNavigatorGroup(
						Messages.NavigatorGroupName_Problem_2005_incominglinks,
						"icons/incomingLinksNavigatorGroup.gif", parentElement);  //$NON-NLS-1$
				Collection<View> connectedViews;
				connectedViews = getIncomingLinksByType(Collections.singleton(sv),
						CodingcontestVisualIDRegistry.getType(LanguageToProblemMapEditPart.VISUAL_ID));
			...
			case LanguageToProblemMapEditPart.VISUAL_ID: {
				...
				CodingcontestNavigatorGroup target = new CodingcontestNavigatorGroup(
						Messages.NavigatorGroupName_LanguageToProblemMap_4001_target,
						"icons/linkTargetNavigatorGroup.gif", parentElement);  //$NON-NLS-1$
				CodingcontestNavigatorGroup source = new CodingcontestNavigatorGroup(
						Messages.NavigatorGroupName_LanguageToProblemMap_4001_source,
	...
	*/
	 ...
	 * @generated
	 */
	private Collection<CodingcontestNavigatorItem> createNavigatorItems(Collection<View> views, Object parent,
			boolean isLeafs) {
		ArrayList<CodingcontestNavigatorItem> result = new ArrayList<CodingcontestNavigatorItem>(views.size());
		for(View nextView : views) {
			result.add(new CodingcontestNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	...
	*/
	public Object getParent(Object element) {
		if(element instanceof CodingcontestAbstractNavigatorItem) {
			CodingcontestAbstractNavigatorItem abstractNavigatorItem = (CodingcontestAbstractNavigatorItem) element;
