 ...
 * @generated
 */
public class CodingcontestInitDiagramFileAction
		implements IObjectActionDelegate
{
	...
	*/
	public void run(IAction action) {
		...
		Wizard wizard = new CodingcontestNewDiagramFileWizard(domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(
				Messages.InitDiagramFile_WizardTitle,
				ContestEditPart.MODEL_ID));
		CodingcontestDiagramEditorUtil.runWizard(getShell(), wizard, "InitDiagramFile"); //$NON-NLS-1$
	}
}
