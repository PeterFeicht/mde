 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.isse.mde.betting.manager.impl.IdElementImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdElementImpl extends MinimalEObjectImpl.Container implements IdElement
{
	...
	{
		return ManagerPackage.Literals.ID_ELEMENT;
	}
	...
	public void setId(String newId)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ManagerPackage.ID_ELEMENT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ManagerPackage.ID_ELEMENT__ID:
				return getId();
		}
