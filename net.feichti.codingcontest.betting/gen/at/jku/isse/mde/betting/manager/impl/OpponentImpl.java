 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.isse.mde.betting.manager.impl.OpponentImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OpponentImpl extends MinimalEObjectImpl.Container implements Opponent
{
	...
	{
		return ManagerPackage.Literals.OPPONENT;
	}
	...
	public void setReference(String newReference)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ManagerPackage.OPPONENT__REFERENCE, oldReference, reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ManagerPackage.OPPONENT__REFERENCE:
				return getReference();
		}
